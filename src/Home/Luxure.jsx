...
function Luxure() {
  return (
    ...
    <div className="text-start text-white py-14 md:px-36 px-8 relative z-[1]">
      <h3 className="md:text-[3rem] text-2xl font-semibold">LUXURY CAR RENTAL IN EMIRATES</h3>
      ...
      <h3 className="md:text-[3rem] text-2xl font-semibold mt-[30px]">What are the requirements to rent a luxury car in Dubai?</h3>
      <p className="md:leading-[30px] md:text-base text-sm">
    ...
    <img className="absolute top-0 left-0 h-full opacity-70 md:block hidden" src="	https://terra-autorent.vercel.app/cars/left-car.png" alt="left car" />
    <img className="absolute top-0 right-0 h-full opacity-70 md:block hidden" src="https://terra-autorent.vercel.app/cars/right-car.png" alt="right car" />
  </section>
  
  )
}

export default Luxure